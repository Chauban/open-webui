...
def get_socketio_transports(enable_websocket_support: bool) -> list[str]:
    # Keep polling as a fallback: upstream offers websocket only, which strands
    # any client whose network cannot upgrade.
...
if WEBSOCKET_MANAGER == 'redis':
    ...
    sio = socketio.AsyncServer(
        ...
        transports=get_socketio_transports(ENABLE_WEBSOCKET_SUPPORT),
